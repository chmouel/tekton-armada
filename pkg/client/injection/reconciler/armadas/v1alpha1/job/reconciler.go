...
type reconcilerImpl struct {
	...
	Lister armadasv1alpha1.JobLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister armadasv1alpha1.JobLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Job, desired *v1alpha1.Job) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.GithubV1alpha1().Jobs(desired.Namespace)
		...
		updater := r.Client.GithubV1alpha1().Jobs(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Job, desiredFinalizers sets.String) (*v1alpha1.Job, error) {
	// Don't modify the informers copy.
	...
	patcher := r.Client.GithubV1alpha1().Jobs(resource.Namespace)
