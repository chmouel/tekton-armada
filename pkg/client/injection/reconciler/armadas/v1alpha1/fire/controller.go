...
import (
	...
	versionedscheme "github.com/chmouel/armadas/pkg/client/clientset/versioned/scheme"
	client "github.com/chmouel/armadas/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "fire-controller"
	defaultFinalizerName       = "fires.github.com/chmouel/armadas"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	fireInformer := fire.Get(ctx)

	lister := fireInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "github.com/chmouel/armadas.Fire"),
	)
